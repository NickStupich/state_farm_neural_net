...
x_input = Input(batch_shape=(batch_size, color_type, img_rows, img_cols))
...
if start_epoch < nb_epoch:    
    ...
    vae.fit(x_train_fit, x_train_fit,
            shuffle=True,
...
if 0:   # build a model to project inputs on the latent space
